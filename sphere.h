...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(1.0f, 1.0f, 0.0f), glm::vec3 diff = glm::vec3(1.0f, 1.0f, 0.0f), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3 emission = glm::vec3(1.0f, 1.0f, 0.0f), float shiny = 32.0f) : verticesStride(24)
    {
    ...
    void set(float radius, int sectors, int stacks, glm::vec3 amb, glm::vec3 diff, glm::vec3 spec, float shiny)
    {
        ...
        this->emission = glm::vec3(1.0f, 1.0f, 0.0f);
    }
